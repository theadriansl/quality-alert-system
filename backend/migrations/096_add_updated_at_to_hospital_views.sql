-- ============================================================================
-- Migración 096: Agregar updated_at a vistas del Hospital de Defectos
-- ============================================================================
-- Propósito: Permitir filtrar por "último movimiento" en el Hospital
-- ============================================================================

-- Vista v_defects_pending_repair (con updated_at)
...
-- Vista v_defects_in_repair (con updated_at)
...
-- Vista v_defects_pending_release (con updated_at y root_cause)
...
-- Comentarios
COMMENT ON VIEW v_defects_pending_repair IS 'Defectos pendientes de reparación con updated_at para filtros';
COMMENT ON VIEW v_defects_in_repair IS 'Defectos en proceso de reparación con updated_at para filtros';
COMMENT ON VIEW v_defects_pending_release IS 'Defectos pendientes de liberación con updated_at y root_cause para filtros';
